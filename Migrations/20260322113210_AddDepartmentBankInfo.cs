...
{
    /// <inheritdoc />
    public partial class AddDepartmentBankInfo : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CalcDetail = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuarterCloses", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "UploadedReceipts",
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UploadedReceipts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExpenseReports_Departments_DepartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAudited = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseReports_DepartmentId",
